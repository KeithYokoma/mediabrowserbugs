package io.github.keithyokoma.mediabrowserbugclient;
...
public class MainActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mMediaBrowserCompat = new MediaBrowserCompat(this, new ComponentName("io.github.keithyokoma.mediabrowserbugs", "io.github.keithyokoma.mediabrowserbugs.ConcreteMediaBrowserService"), new ConnectionCallback() {
			@Override
	...
	public void onClickLoadChildren(View v) {
		...
		mMediaBrowserCompat.subscribe(mMediaBrowserCompat.getRoot(), new SubscriptionCallback() {
			@Override
